...
#img_dirs = ['/home/ist/zhq/SGAN_adversarial-steganography-master/data/10_seeds/other_seeds/']  #/home/dvolkhonskiy/SGAN/code/data/overtraining/plus_%s
img_dirs = ['/home/ist/zhq/SGAN_adversarial-steganography-master/data/overtraining/test_%s'% i for i in range(0, 10)]

img_dirs.append('/home/ist/zhq/SGAN_adversarial-steganography-master/data/overtraining/train/')
#img_dirs.append(')
...
def apply_matlab_stego(img):
    ...
    return getoutput('/home/ist/zhq/SGAN_adversarial-steganography-master/matlab_stego/HUGO/run_hugo_train.m %s' % img)
