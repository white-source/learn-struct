...
flags.DEFINE_integer("image_size", 128, "The size of image to use (will be center cropped) [108]")         ###108
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        if FLAGS.is_train:
            ...
            dcgan.load(FLAGS.checkpoint_dir, 17) # 50400 50800
        ...
        for i in range(n_batches):
            ...
            save_images(samples, i, folder='/home/amax/wjx/sgan_generated')
